...
$(test_dir)/test_io_lib: $(test_dir)/test_io_lib.c
	$(CC) $(CFLAGS) $(INCFLAG) $(MARCOFLAG) -lcunit $(library_dir)/io_lib.c $(library_dir)/debug_lib.c $(test_dir)/test_io_lib.c -o $(test_dir)/test_io_lib
